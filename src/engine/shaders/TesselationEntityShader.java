...
public class TesselationEntityShader extends ShaderProgram {

	private static final int MAX_LIGHTS = 4;

	private static final String VERTEX_FILE = "src/engine/shaders/tessEntityVertexShader.txt";
	private static final String FRAGMENT_FILE = "src/engine/shaders/tessEntityFragmentShader.txt";
	...
	public TesselationEntityShader() {
